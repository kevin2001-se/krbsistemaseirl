...
--
-- Servidor: localhost
-- Tiempo de generación: 10-01-2022 a las 19:45:16
-- Versión del servidor: 10.2.41-MariaDB
...
INSERT INTO `pagina` (`id_pagina`, `nombre_web`, `titulo`, `correo_recibo`, `numero_wsp`, `descripcion`, `palabras_claves`, `logo_pestana`, `logo_pagina`, `redes_sociales`, `fecha_creacion`, `fecha_actualizacion`, `id_usuario`) VALUES
(1, 'KRBSistemas E.I.R.L.', 'KRBSistemas E.I.R.L. | Informatica', 'contactokrb@krbsistemas.com', '+51957236792', 'Empresa KRBSistemas ofrece productos Tecnológicos de informática, Sistema  informático para Negocios, Punto de Venta para boticas y farmacias, Bazares, Tienda Repuestos, Mini market, Distribuidoras.', 'ventas,krbsistemas,computadoras,KRBSISTEMAS,Monitores,soporte,computacion,venta de computadoras,computadoras en venta,articulos de computacion,tienda de computacion,sistema de botica', 'icon-logo.ico', 'logoWeb.png', 'null', '2022-01-10 12:56:12', '2021-12-12 13:05:09', 1);
...
(11, 'PC COMPLETA CORE I5 3RA GEN. + SISTEMA DE VENTAS (FARMACIA / BOTICA / BAZAR) GARANTÍA 12 MESES CAPACITACIÓN PERMANENTE.', 1, '1990.00', 'core-i5-monitor-teclado.jpeg', '2022-01-08 02:20:02', 1, NULL);
...
(1, 'SISTEMA INFORMÁTICO PARA NEGOCIOS FARMACIAS, BOTICAS, BAZAR.', 'SISTEMA GESTIÓN CONTROL INVENTARIO Y VENTAS (PUNTO DE VENTA) <a href=\"https://www.youtube.com/watch?v=v0AmcDuB_5w&t=21s\">https://www.youtube.com/watch?v=v0AmcDuB_5w&t=21s</a>', '699.00', 'sistemagestion.png', '2022-01-09 21:42:05', 1, '2021-12-13 13:04:54'),
(2, 'SISTEMA GESTION VENTAS(FACFARMA) + INTEGRACION FACTURACION ELECTRONICA + TICKETERA TERMICA + LECTOR CODIGO BARRAS + 10 CONTOMETROS 80MM.', 'SISTEMA INFORMATICO PARA NEGOCIOS DE PUNTO DE VENTAS.\r\n<a href=\"https://www.youtube.com/watch?v=ZjtkJQlT0Gg\">https://www.youtube.com/watch?v=ZjtkJQlT0Gg</a>', NULL, 'sistemagestion.png', '2022-01-04 20:12:47', 1, '2021-12-13 13:04:54'),
(3, 'PACK SISTEMA INFORMÁTICO PUNTO VENTA PARA BOTICA Y OTROS NEG.+ INTEGRACIÓN FACTURACIÓN ELECTRÓNICA.(EMITE BOLETAS Y FACTURAS).', NULL, NULL, 'sistemagestion.png', '2022-01-09 21:43:14', 1, '2021-12-13 13:04:54');
